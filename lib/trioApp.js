...
require('ng').module('trioApp', [
    require('ng-uiRouter').name,
    require('ng-translate').name,
    require('oil-ui/links').name,
    require('oil-ui/headerfooter').name,
    require('./main/main').name,
    require('./callCustomerCenter/callCustomerCenter').name,
    require('./wizard/wizard').name,
    require('./order/order').name
])
